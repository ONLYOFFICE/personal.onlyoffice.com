...
const StyledText = styled.p`
    ...
    text-transform: ${(props) => (props.textTransform || props.theme.text.textTransform)};
    ...
    &:hover{
        text-decoration: ${(props) => (props.hoverTextDecoration || props.theme.text.hoverTextDecoration)};
    }

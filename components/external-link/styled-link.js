...
text-transform: ${(props) => (props.textTransform || props.theme.a.textTransform)};
...
text-decoration: ${(props) => (props.textDecoration || props.theme.a.textDecoration)};
    &:hover{
        cursor: pointer;
        text-decoration: ${(props) => (props.hoverTextDecoration || props.theme.a.hoverTextDecoration)};
    }
`;
